...
var file_order_management_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x6c, 0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x64, 0x53,
	...
	0x64, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xdd, 0x02, 0x0a, 0x0f,
...
var file_order_management_proto_goTypes = []interface{}{
	(*CombinedShipment)(nil),       // 0: ecommerce.CombinedShipment
...
var file_order_management_proto_depIdxs = []int32{
	...
	1, // 1: ecommerce.OrderManagement.addOrder:input_type -> ecommerce.Order
	...
	1, // 4: ecommerce.OrderManagement.updateOrders:input_type -> ecommerce.Order
	...
	1, // 7: ecommerce.OrderManagement.getOrder:output_type -> ecommerce.Order
	1, // 8: ecommerce.OrderManagement.searchOrders:output_type -> ecommerce.Order
	2, // 9: ecommerce.OrderManagement.updateOrders:output_type -> google.protobuf.StringValue
	0, // 10: ecommerce.OrderManagement.processOrders:output_type -> ecommerce.CombinedShipment
